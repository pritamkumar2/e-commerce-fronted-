...
export default function Product() {
  ...
  }, [availability, category, sort, page, minPrice, maxPrice]);
  ...
  const handleFilter = (value, sectionId) => {
    ...
    console.log("filterValues - ", filterValues, value, sectionId);
  ...
  return (
    <div className="bg-white -z-20  ">
      <div>
        ...
        <Transition.Root show={mobileFiltersOpen} as={Fragment}>
          ...
          >
            ...
            <div className="fixed inset-0 z-40 flex">
              ...
              >
                <Dialog.Panel className="filterData relative ml-auto flex h-full w-full max-w-xs flex-col overflow-y-auto bg-white py-4 pb-12 shadow-xl">
        ...
        <main className="mx-auto px-4 lg:px-14  mt-8">
